module Jekyll
  class CodeBlockTag < Liquid::Block
    ...
    def render(context)
      ...
      <<~HTML
        <section data-filename=\"#{filename}\" data-code=\"#{escaped_code_content}\" data-download-link data-download-link-label=\"#{download_label}\" class=\"line-numbers\" style=\"white-space:pre-wrap;\"><code class=\"language-#{@language}\">#{code_content}</code></section>
      HTML
    end
  end
end
