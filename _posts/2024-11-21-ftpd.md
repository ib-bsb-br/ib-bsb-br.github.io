...
```bash
echo -e "--- FTP Connection Details ---\nHost (IP Address): $(hostname -I)\nUsername: ftpuser\nPassword: [Cannot be retrieved - use the password you set for 'ftpuser']\nPort: 21\nPassive Port Range (Server Config): 30000-35000 (not entered in FileZilla Port field)\n----------------------------"
```
