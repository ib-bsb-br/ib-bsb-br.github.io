...
<script src="{{ '/assets/js/simple-jekyll-search-setup.js' | relative_url }}" defer></script>
...
<aside class="search-aside aside" style="margin: 20px 0;
 ...
 <section class="sjs-search" aria-label="Simple Jekyll Search fallback">
   <label for="search-input" class="sjs-label">Local post search</label>
   <input type="search" id="search-input" placeholder="Search posts, tags, keywords..." autocomplete="off">
   <p id="search-status" class="sjs-status">Type to search all posts.</p>
   <ul id="results-container" class="sjs-results" aria-live="polite"></ul>
 </section>
