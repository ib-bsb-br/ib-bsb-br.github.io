...
INTEGRATION NOTES
────────────────────────────────────────────────────────────────────────
• Place your chosen template in a file (e.g., minimal_example.j2).  
• Run:  
     python f2p.py -t minimal_example.j2 /path/to/files  
• Make sure Jinja2 is installed (pip install jinja2).  
• If you want to adapt these to your own variables, ensure that the script is modified accordingly or that the script supplies those variables to the Jinja2 environment.
