...
Purpose: Turns each file’s content into a set of blockquotes with line numbers (handy for review in Markdown).
...
Purpose: Great for re-creating multiple file contents on another system or environment.
