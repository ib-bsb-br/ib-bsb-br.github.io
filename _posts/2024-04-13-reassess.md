...
<input_specification>
  <variable>
    <name>[[immediately previous AI-generated response]]</name>
    <description>The full content of the immediately previous given AI-generated response. This includes all text data, attached files, urls, images, etc.</description>
    <value>"`The full content of the entire AI ASSISTANT's last response (the response that immediately preceded this request); accessible from this conversation context/chat history and it may be in plain text, markdown, pdf, urls, attached files, images, etc.`"</value>
  </variable>
</input_specification>
