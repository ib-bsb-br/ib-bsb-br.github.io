...
* **Output:** A well-formed, syntactically valid draft XML prompt. Example (with context/comments):
    ```xml
    <prompt>
      <purpose>Generate extensive, factual summaries of technical articles for a managerial audience.</purpose>
    ...
    <instructions>
        ...
        <instruction>Synthesize these points into a extensive summary, adhering to all constraints in the <context> section.</instruction>
